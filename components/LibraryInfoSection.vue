<template>
  <section class="bg-white dark:bg-zinc-950 border-t border-gray-200 dark:border-gray-800 relative overflow-hidden">
    <!-- Subtle background effect -->
    <div
      class="absolute inset-0 bg-gradient-to-b from-transparent via-python-blue-50/20 to-transparent dark:via-python-blue-950/10 pointer-events-none" />

    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <!-- Left Side Ad -->
        <div class="hidden lg:block lg:col-span-2">
          <div class="sticky top-20 flex justify-center">
            <ClientOnly>
              <Adsense client="ca-pub-1356911639243870" ad-slot="9381101962" format="vertical"
          ...
          <div class="max-w-5xl mx-auto">
            ...
            <div class="mt-12 flex flex-wrap items-center justify-center gap-4">
              <div v-for="tech in techStack" :key="tech.name"
                class="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-zinc-800 rounded-full border border-gray-200 dark:border-gray-700">
        ...
        <div class="hidden lg:block lg:col-span-2">
          <div class="sticky top-20 flex justify-center">
            <ClientOnly>
              <Adsense client="ca-pub-1356911639243870" ad-slot="8625659151" format="vertical"
                style="display:block; width: 100%;" />
            </ClientOnly>
          </div>
        </div>
...
// Technology stack
const techStack = [
  { name: 'Pyodide', icon: 'simple-icons:python', color: 'text-python-blue-600' },
  { name: 'WebAssembly', icon: 'simple-icons:webassembly', color: 'text-purple-600' },
  { name: 'Monaco Editor', icon: 'simple-icons:visualstudiocode', color: 'text-blue-600' },
  { name: 'Python 3.13', icon: 'simple-icons:python', color: 'text-yellow-500' }
]
</script>
