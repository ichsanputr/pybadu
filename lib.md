...
print(Template("Hello {{name}}").render(name="Ichsan"))
...
import dateparser
print(dateparser.parse("tomorrow at 5pm"))

50. jmespath

Query JSON (XPath-like)
📘 https://jmespath.org/

import jmespath
print(jmespath.search("foo.bar", {"foo":{"bar":1}}))

✅ Markdown file selesai.