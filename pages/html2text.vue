    ...
    <LibraryInfoSection>
      <div class="text-center mb-12">
        ...
        <div class="max-w-4xl mx-auto text-left space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <p class="text-base md:text-lg leading-relaxed">
            This compiler loads html2text entirely in the browser so you can experiment with conversion options before wiring them into a pipeline. Test different body widths, disable automatic links, keep line breaks, or tweak inline emphasis and see results instantly without installing anything locally.
          </p>
