    ...
    <LibraryInfoSection>
      <div class="text-center mb-12">
        ...
        <div class="max-w-4xl mx-auto text-left space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <p class="text-base md:text-lg leading-relaxed">
            This compiler bundles SymPy directly in the browser so you can explore symbolic math without installing dependencies or configuring kernels—it’s completely free. Differentiate expressions, solve equations, simplify identities, experiment with series, or generate code for numerical backends before bringing the logic into notebooks or services.
          </p>
