    ...
    <LibraryInfoSection>
      <div class="text-center mb-12">
        ...
        <div class="max-w-4xl mx-auto text-left space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <p class="text-base md:text-lg leading-relaxed">
            This compiler bundles validators in the browser so you can prototype validation logic, test edge cases, and compare options instantly—no installations, dependencies, or setup required, and it’s completely free. Check whether strings are RFC-compliant emails, detect disposable domains, verify IPv4/IPv6, ensure URLs include schemes, or customize error messages before wiring them into APIs, CLIs, or data-ingestion pipelines.
          </p>
